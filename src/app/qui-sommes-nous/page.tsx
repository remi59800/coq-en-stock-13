          ...
          <div className='hidden md:flex md:justify-center max-w-2xl mx-auto py-8 mt-10'>
            <div className='flex flex-col items-center w-full max-w-[320px]'>
              ...
              <p className='text-center text-sm font-nunito'>
                ...
                la partie rôtisserie ainsi que de la partie grillades.
              </p>
            </div>
            ...
            <div className='w-full mx-auto grid grid-cols-1 items-center'>
              ...
              <div className='flex flex-col items-center md:items-start px-8 md:px-0 pt-9 text-primary'>
                ...
                <p className='text-center md:text-left text-sm font-nunito'>
                  ...
                  ville se reflète dans nos saveurs et notre engagement à
                  partager cette histoire d&apos;amour avec vous.
                </p>
              </div>
              <div className='flex flex-col items-center md:items-start px-8 md:px-0 pt-7 pb-9 text-primary'>
                ...
                <p className='text-center md:text-left text-sm font-nunito'>
                  ...
                  boulevard Haussmannien, qui après de nombreux changements ces
                  dernières années, était victime d’une mauvaise réputation
                  auprès des Marseillais. La bonne humeur légendaire des
                  nordistes et des bons petits plats sont les ingrédients
                  parfaits pour insuffler une nouvelle dynamique à ce si beau
                  boulevard, n&apos;est-ce pas ?
                </p>
              </div>
            </div>
          </div>
