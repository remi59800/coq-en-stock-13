    ...
    <main>
      <div className='relative w-full flex'>
        ...
        <div className='flex flex-col items-center text-primary max-w-3xl mx-auto'>
          ...
          <h2 className='text-center font-black text-lg pt-8 pb-2 tracking-[3px]'>
            ÉVÉNEMENTS
          </h2>
          <p className='text-center text-sm font-nunito pt-2 w-[80%]'>
            ...
            spécifiques, pour garantir une prestation parfaitement adaptée à vos
            besoins. Contactez-nous pour élaborer ensemble une offre
          ...
          >
            <div className='flex flex-row items-center'>
              <Image
                ...
                priority
              />
              <p className='pl-2.5'>NOUS CONTACTER</p>
            </div>
          </Link>
        </div>
      </div>
